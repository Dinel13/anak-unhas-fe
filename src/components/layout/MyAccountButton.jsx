      ...
      >
        {profile && (
          <div className="w-48 dark-sidebar absolute rounded-lg right-0 shadow-lg top-0 mt-10">
            <Link
              to="/akunku"
              className="flex items-center cursor-pointer p-2 rounded-t-lg hover:text-rose-300 hover:dark-nav"
            >
              <svg
            ...
            <Link
              to="/chat"
              className="flex items-center cursor-pointer p-2 hover:text-rose-300 hover:dark-nav"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
